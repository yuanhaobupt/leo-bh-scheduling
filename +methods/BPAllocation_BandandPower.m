function BPAllocation_BandandPower(interface)
...
% a(ii) = allocPower(ii,ii) * (3e8/curFc / 4 * pi * d(ii))^2 * Gsat * Gusr / N_noise_usr;
...
% temp_a(ii) = allocPower(ii,ii) * (3e8/curFc / 4 * pi * d(ii))^2 * Gsat * Gusr / N_noise_usr;
